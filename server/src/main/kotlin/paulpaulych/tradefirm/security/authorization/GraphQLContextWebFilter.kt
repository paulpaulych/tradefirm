...
class GraphQLContextWebFilter(
        ...
        private val contextFactory: SecurityGraphQLContextFactory
): ContextWebFilter<SecurityGraphQLContext>(config, contextFactory) {
    ...
    private fun getSecurityContext(reactorContext: ReactorContext): Mono<SecurityContext>? =
        reactorContext.context.getOrDefault<Mono<SecurityContext>>(SecurityContext::class.java, null)
